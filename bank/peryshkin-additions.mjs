// Calculation tasks transcribed from the supplied scanned collection:
// printed pages 54 (grade 7), 113 (grade 8), 164 and 200 (grade 9).
const source=number=>({
...
function calculation({grade,number,section,paragraph,topic,task,answer,unit,prompt,difficulty='БАЗОВЫЙ',tolerance=.01}){
  return {
    ...
    ANSWER:{mode:'numeric',value:answer,unit,tolerance},
    ANSWER_PROMPT:prompt,STATUS:'VERIFIED',SOLUTION:[],FORMULAS:[],
